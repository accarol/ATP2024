...
def filtrar_date(dataset): # está a dar mal
    layout = [
    ...
    while not stop:
        ...
        if event == sg.WINDOW_CLOSED or event == "-CANCELAR-":
            ...
            if lista_registos:
                ...
                sg.popup(f"Registo com título '{date}' não encontrado.", title="Insucesso")
...
def filtrar_author(dataset): # está a dar mal
    layout = [
    ...
    while not stop:
        ...
        if event == sg.WINDOW_CLOSED or event == "-CANCELAR-":
            ...
            if lista_registos:
                ...
                sg.popup(f"Registo com título '{author}' não encontrado.", title="Insucesso")
    ...
    while not stop:
        ...
        if event == sg.WINDOW_CLOSED or event == "-CANCELAR-":
            ...
            if lista_registos:
                ...
                sg.popup(f"Registo com palavra-chave '{affiliation}' não encontrado.", title="Insucesso")
